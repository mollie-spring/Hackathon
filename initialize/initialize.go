...
func Setup() (*abe.FAME, *abe.FAMEPubKey, *abe.FAMEAttribKeys, *abe.FAMEAttribKeys, *abe.FAMEAttribKeys, *abe.MSP, *abe.MSP, *abe.MSP, *abe.MSP, *abe.MSP) {
	...
	return a, pubKey, manager_keys, auditor_keys, supervisor_keys, mspAudit, mspBreakGlass, mspA, mspB, mspAll
}
